...
Rails.application.configure do
  ...
  # Use SemanticLogger for structured logging with Honeybadger integration
  # SemanticLogger is configured in config/initializers/semantic_logger.rb
  # Logs are automatically tagged with request_id and streamed to Honeybadger
